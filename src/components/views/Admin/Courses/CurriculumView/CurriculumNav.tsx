      ...
      <section className={cn([inter.className, "relative min-h-screen"])}>
        ...
        <button
          ...
          className={cn([
            ...
            "sticky hidden md:block cursor-pointer delay-700 duration-300 transition-transform top-20 bg-primary pl-2 pr-4 rounded-r-full py-2",
          ])}>
        ...
        <div className="flex justify-between ">
          <aside
            ...
            className={cn([
              ...
              "md:top-16 md:bottom-auto md:h-[calc(100vh-4rem)]",
            ])}>
            <div className="flex h-full flex-col">
              {/* Header (non-scrolling) */}
              <header className="shrink-0 flex items-center justify-between pl-7 pr-4 py-3 border-abu">
                <h5 className="font-semibold 2xl:text-xl text-lg m-0 text-slate-700">Daftar Modul</h5>
