...
export type RemoveQuestionParams = { id: number; questionId?: never } | { id?: never; questionId: string };
...
export type QuizQuestionFieldArray = UseFieldArrayReturn<QuizEditorForm, "questions", "questionId">;
