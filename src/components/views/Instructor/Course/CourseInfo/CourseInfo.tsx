        ...
        <div className="flex-1">
          <div className="flex gap-8 flex-col sm:flex-row">
            <div className="max-w-96 w-full h-fit aspect-video rounded-lg overflow-hidden relative bg-red-50">
              <Image src={data.coverImage} alt="course image" fill objectFit="contain" />
            </div>
...
const SyllabusTab = ({ sections }: { sections: { title: string; lesson?: string[] }[] }) => {
  return (
