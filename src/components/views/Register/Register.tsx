  ...
  return (
    <div className="flex flex-row">
      <section
        className={cn([
          poppins.className,
          "bg-prime hidden w-1/2 lg:flex flex-col items-center min-h-screen",
        ])}>
      ...
      <section className="min-h-screen w-full lg:w-1/2 flex flex-col justify-center items-center bg-main">
        ...
        <div className="lg:w-3/4 xl:w-2/4 w-[80%] mt-12 flex flex-col items-center gap-5">
          <h2 className={cn([poppins.className, "text-2xl "])}>Sign Up</h2>
          <Input
            label="Username"
            type="text"
            variant="faded"
          ...
          <p className={cn([poppins.className])}>
            ...
            <Link className="text-prime ml-2" href="/auth/login">
              Login Here
            </Link>
          </p>
        </div>
