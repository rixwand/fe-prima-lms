...
export default function LessonContent({ id, ...ids }: { id: number; sectionId: number; slug: string }) {
  const { data, isLoading, isError, error } = useQuery(learnQueries.options.getLessonContent({ itemId: id, ...ids }));
