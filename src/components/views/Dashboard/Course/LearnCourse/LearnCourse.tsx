    ...
    <article className="mx-auto md:-mt-14 -mt-3 mb-16 max-w-3xl px-5 py-8 lg:py-10 text-zinc-800">
      ...
      <section className="space-y-5">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm p-5">
          ...
          <p className="mt-2 leading-7 text-zinc-700">
            Materi dalam kursus ini sebagian besar disajikan dalam bentuk teks
            yang sistematis dan mudah dipahami. Format ini dipilih karena
            efektif untuk memperdalam pemahaman dan memudahkan peserta dalam
            mempraktikkan langsung langkah-langkah penggunaan Microsoft Word.
          </p>
        </div>
      ...
      <section className="space-y-5 mt-10">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm p-5">
          ...
          <p className="mt-2 leading-7 text-zinc-700">
            ...
            mengevaluasi pemahaman Anda, serta ujian akhir kelas yang mencakup
            keseluruhan materi. Jika terdapat soal yang sulit dijawab, sebaiknya
            Anda mengulang kembali materi yang bersangkutan.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm p-5">
          ...
          <p className="mt-2 leading-7 text-zinc-700">
            Setiap peserta akan diberikan tugas praktik berupa dokumen Microsoft
            Word yang harus dikerjakan secara mandiri dan diunggah sebagai bukti
            pemahaman. Tugas ini akan diperiksa oleh instruktur.
          </p>
          <div className="mt-3 rounded-xl border border-rose-200 bg-rose-50 p-4 text-rose-900">
            <p className="text-sm leading-6">
              ...
              secara jujur. Segala bentuk plagiasi akan dikenai sanksi, mulai
              dari peringatan hingga dikeluarkan dari kelas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4 mt-10">
        ...
        <ul className="list-disc pl-6 leading-7 text-zinc-700 space-y-2">
          <li>
            Informasi lebih lanjut mengenai sistem penilaian, tenggat waktu, dan
            sertifikat akan dijelaskan oleh instruktur di awal pertemuan.
          </li>
          <li>
            Pastikan perangkat Anda sudah terinstal Microsoft Word dan memiliki
            koneksi internet yang stabil jika mengikuti kursus secara online.
          </li>
          <li>
            Gunakan waktu belajar sebaik mungkin, dan jangan ragu untuk bertanya
