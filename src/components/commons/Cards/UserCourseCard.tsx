...
const UserCourseCard = ({ link = "/course/test" }: { link?: string }) => {
  return (
    <Link href={link}>
      <Card
        ...
        <CardFooter className="relative flex-col gap-y-0.5 lg:gap-y-2 items-start p-4 overflow-hidden">
          ...
          <div className="flex gap-x-3 mt-1">
            ...
            <div className="items-start">
              <p className="text-xs text-start font-semibold text-default-500">Muhammad Fuad Abdullah</p>
              <p className="text-xs text-start text-default-400">Wordpress Designer</p>
            </div>
          </div>
