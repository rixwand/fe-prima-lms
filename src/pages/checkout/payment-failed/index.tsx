...
export default function PaymentFailed() {
  return (
    <AuthLayout>
      <AuthStatusCard title="Pembayaran Gagal" subtitle="Periksa email Anda untuk mengaktifkan akun.">
        <div className="flex flex-col items-center gap-4 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-danger">
